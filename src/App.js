...
class App extends Component {
  ...
  search(e){
    e.preventDefault();
    window.location.assign(`https://stockfootage.com/?s=buisness+${this.state.search}&post_type=product`);
  }
  render() {
    return (
      <div className="App">
        ...
        <div id="vidtop-content">
          ...
          <div className="interact-box">
            <img src={logo} alt=""/>
            <h1><span style={{color: 'rgb(188, 52, 38)'}}>BusinessStock</span>Footage.com</h1>
        ...
        <div className="info-sec">
          <section>
            <h1>Business <a className="rf" href="https://en.wikipedia.org/wiki/Royalty-free">Royalty-Free</a> Stock Footage Marketplace (contact us for 4K)</h1>
            <h4 className="sub-banner">BusinessStockFootage.com is a division of <a style={{textDecoration:'none', color: '#999'}} href="https://stockfootage.com/">StockFootage.com</a></h4>
          </section>
          ...
          <section className="contributors">
            ...
            <div className="contributor-previews">
              <div className="contributor-preview">
                <iframe title="yt1" width="350" height="195" src="https://www.youtube.com/watch?v=GvVvNHmU2Fk&feature=youtu.be" frameBorder="0" allowFullScreen></iframe>
              </div>
              <div className="contributor-preview">
                <iframe title="yt2" width="350" height="195" src="https://www.youtube.com/watch?v=giy37cf1msI" frameBorder="0" allowFullScreen></iframe>
              </div>
              <div className="contributor-preview">
                <iframe title="yt3" width="350" height="195" src="https://www.youtube.com/watch?v=nHYt9xsprzk" frameBorder="0" allowFullScreen></iframe>
              </div>
            </div>

            <div className="mobile-contributor-previews">
              <div className="contributor-preview">
                <iframe title="yt4" width="250" height="150" src="https://www.youtube.com/watch?v=GvVvNHmU2Fk&feature=youtu.be" frameBorder="0" allowFullScreen></iframe>
              </div>
              <div className="contributor-preview">
                <iframe title="yt5" width="250" height="150" src="https://www.youtube.com/watch?v=giy37cf1msI" frameBorder="0" allowFullScreen></iframe>
              </div>
              <div className="contributor-preview">
                <iframe title="yt6" width="250" height="150" src="https://www.youtube.com/watch?v=nHYt9xsprzk" frameBorder="0" allowFullScreen></iframe>
              </div>
            </div>
